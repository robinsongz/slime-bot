        ...
        const [ prop ] = args;
            ...
            if (message.channel.name === teamChannel) {
                ...
                if (foundPatreon === true || foundGm === true) {
                        ...
                        // variable for getting team team from enmap
                        let team1 = enmap.get(message.guild.id, 'patreonTeam.team1.team');
                        let team2 = enmap.get(message.guild.id, 'patreonTeam.team2.team');
                        let team3 = enmap.get(message.guild.id, 'patreonTeam.team3.team');

                        // variable for team team
                        let teamTeam1 = 'patreonTeam.team1.team';
                        let teamTeam2 = 'patreonTeam.team2.team';
                        let teamTeam3 = 'patreonTeam.team3.team';
                        
                        // variable for team name
                        let teamName1 = 'patreonTeam.team1.name';
                        let teamName2 = 'patreonTeam.team2.name';
                        let teamName3 = 'patreonTeam.team3.name';
                        ...
                        // variable for getting party name from enmap
                        let name1 = enmap.get(message.guild.id, 'patreonTeam.team1.name');
                        let name2 = enmap.get(message.guild.id, 'patreonTeam.team2.name');
                        let name3 = enmap.get(message.guild.id, 'patreonTeam.team3.name');
